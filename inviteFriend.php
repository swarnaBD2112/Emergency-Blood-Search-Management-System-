...
<h1 class="text-primary text-center"> INVITE FRIENDS </h1>
...
.......................................................................................................................
	...
	<?php
	                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
							//Email information
							  $admin_email = "nsrsbp@gmail.com";
							  $email1 = $_POST['email1'];
							  $email2 = $_POST['email2'];
							  $email3 = $_POST['email3'];
							$subject="An Invitation From Your Friend, $username";
							 // $comment = $_REQUEST['comment'];
							$comment="Know about blood Donation and Become a donor today.";
							  //send email
							mail($admin_email, "$subject", $comment, "From:" . $email1);
							mail($admin_email, "$subject", $comment, "From:" . $email2);
							mail($admin_email, "$subject", $comment, "From:" . $email3);				
							  //Email response
	...
	<div class="form-group">
		<label class="control-label col-sm-2 col-sm-offset-2 " for="email1">Email:</label>
		<div class="col-sm-5">
		  <input type="email" class="form-control" name="email1" id="email1" placeholder="Enter your friend's email">
		</div>
	</div>
	<div class="form-group">
		<label class="control-label col-sm-2 col-sm-offset-2 " for="email2">Email:</label>
		<div class="col-sm-5">
		  <input type="email" class="form-control" name="email2" id="email2" placeholder="Enter your friend's email">
		</div>
	</div>
	<div class="form-group">
		<label class="control-label col-sm-2 col-sm-offset-2 " for="email3">Email:</label>
		<div class="col-sm-5">
		  <input type="email" class="form-control" name="email3" id="email3" placeholder="Enter your friend's email">
		</div>
	</div>
	
	<div class="form-group">
		<div class="col-sm-offset-5 col-sm-10">
			<button id="Update" type="submit" name="Update"  class="btn btn-primary">Send</button>
