...
<h1 class="text-primary text-center"> Donation Experiences </h1>
<div class="btn-group pull-right">
                <div class="btn-group">
                <a class="btn   btn-info"   href="newExperience.php">
                    Add New 
...
.......................................................................................................................
	...
	<small>
	<?php
		$allinfo= $user->getAllExperience();
		foreach ($allinfo as $info){
			?>
			<div class="page-header text-center ">
				<h2 class="text-primary text-left"><?php echo $info['name']?>, <small><?php echo $info['date']?></small></h2>
			</div>	
			<div class="alert alert-warning" role="alert"><h5><?php echo $info['message']?></h5></div>
