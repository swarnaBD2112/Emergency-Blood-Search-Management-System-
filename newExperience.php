...
<body >
  ...
  <!-- NAVBAR================================================== -->
	...
	<h1 class="text-primary text-center"> Share Your Experience </h1>
...
.......................................................................................................................
	...
	<?php
		if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	        ...
	        if (empty($name) or empty($message)) {
	            ...
	            $save = $user->SaveExperience($name, $message);	                                    	
	        }	                  
	    }
	?>	                    
	</small>
	...
	<div class="form-group">
		<label class="control-label col-sm-2 col-sm-offset-2 " for="message">Meassage:</label>
		<div class="col-sm-5">   
		  <input type="text" class="form-control" name="message" id="message" placeholder="share your exparience here">
		</div>
	</div>
	
	<div class="form-group">
		<div class="col-sm-offset-5 col-sm-10">
			<button id="send" type="submit" name="send"  class="btn btn-primary">Send</button>
